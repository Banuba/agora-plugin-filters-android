...
void main()
{
    ...
    vec3 additionColor = texture(glfx_VIDEO, scaleUV(video_color_uv, vec2(0.7))).rgb;
    ...
    frag_color = vec4(color * 2.0 , opacity * 0.5 ) * 2.0;
    // frag_color = texture(glfx_VIDEO, var_uv);
#ifdef GLFX_OCCLUSION
