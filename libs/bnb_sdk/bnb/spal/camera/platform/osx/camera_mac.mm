...
namespace
{
    ...
    static auto get_color_standard(CVPixelBufferRef pixelBuffer)
    {
        color_std standard = color_std::bt601;

        CFStringRef color_attachments_string_ref = (CFStringRef) CVBufferGetAttachment(pixelBuffer, kCVImageBufferYCbCrMatrixKey, NULL);
        if (color_attachments_string_ref == kCVImageBufferYCbCrMatrix_ITU_R_709_2) {
            standard = color_std::bt709;
        }
...
- (void)processFrame:(CMSampleBufferRef)sampleBuffer
{
    ...
    switch (pixelFormat) {
        case kCVPixelFormatType_420YpCbCr8BiPlanarFullRange: {
            ...
            yuv_format_t yuv_format = {color_range::full, get_color_standard(pixelBuffer), yuv_format::yuv_nv12};
        ...
        case kCVPixelFormatType_32ARGB: {
            ...
            camera_base::current_format = camera_base::camera_format::RGBA;
        } break;
        default:
