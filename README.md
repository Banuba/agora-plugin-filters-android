...
1. Get
[(a) The latest Banuba SDK archive and (b) BanubaFiltersAgoraExtension for Android](https://f.hubspotusercontent10.net/hubfs/4992313/Agora_Banuba_Extension/AgoraBanubaExtension_Android_v0.x.x.zip),
...
9. Visit agora.io to sign up and get token, app and channel ID
10. Copy and Paste your agora token, app and chanel ID into appropriate section of `app/src/main/java/com/banuba/sdk/agorapluginexample/ClientToken.kt` with “ ” symbols. For example: AGORA_APP_ID = “place_your_token_here”
